...
void WebRtcNS::_noiseSuppression32(string input_path, string output_path, int nSample, int nMode)
{
...
void WebRtcNS::_noiseSuppressionX32(char* szFileIn, char* szFileOut, int nSample, int nMode)
{
	int nRet = 0;
...
void WebRtcNS::_agc(string input_path, string output_path, int fs)
...
void WebRtcNS::_getFiles(string path, vector<string>& files, vector<string>& files_alone)
{
	//文件句柄
	intptr_t hFile = 0;
	//文件信息
...
void WebRtcNS::doNSAgc(std::string filePath)
{
...
int WebRtcNS::doNS(char* pInBuffer, char* pOutBuffer, int len, int nSample, int nMode)
{
	int nRet = 0;
	NsHandle* pNS_inst = NULL;
	int nTime = 0;
...
int WebRtcNS::doAgc(char* pInBuffer, char* pOutBuffer, int length, int fs)
{
	int count = 0;
	int i = 0;
